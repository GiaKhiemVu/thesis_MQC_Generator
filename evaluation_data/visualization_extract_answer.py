...
# File paths
file_paths = {
    "Model-500": "extract_answer_models/eval_report_final-model-500.json",
    "Model-1000": "extract_answer_models/eval_report_final-model-1000.json",
    "Model-1500": "extract_answer_models/eval_report_final-model-1500.json",
    "Model-2000": "extract_answer_models/eval_report_final-model-2000.json"
}
...
ax.set_ylim(0.85, 1.01)  # 🔍 Make differences clearer in high score range
ax.legend()
ax.grid(True, linestyle='--', alpha=0.6)

# Save the bar chart as PDF
bar_chart_path = "evaluation_data/compare_output_extract_answer_models.pdf"
plt.tight_layout()
